...
namespace Medallyon
{
    public interface ISaveable
    {
        ...
        /// </summary>
        /// <param name="data">A Dictionary mapping the name of a Field or Property in this class marked with the <see cref="SaveAttribute" /> to its serialized value.</param>
